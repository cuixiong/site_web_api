...
class AirwallexPay extends Pay {
    ...
    public function __construct() {
        ...
        \Log::error('返回结果数据:'.json_encode([$this->apiUrl, $this->client_id , $this->secret_id , $this->webhook_id, $this->env]).'  文件路径:'.__CLASS__.'  行号:'.__LINE__);
    }
    ...
    public function do($order, $options = []) {
        ...
        list($code, $resData) = $airwallex->request('POST', '/pa/payment_intents/create', $payData);
